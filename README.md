...
- **[Claude system prompt evolution, Apr 2025  to Apr 2026](./experiments/claude-prompt-evolution/)**. open `index.html` in a browser and compare versions over time. Useful as a concrete example of how tool, safety, and behavioral guidance evolve as a harness matures.
